  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        link: "text-foreground hover:text-accent no-underline",
        // CTA buttons for landing page - blue with black hover
        cta: "bg-primary text-primary-foreground hover:bg-foreground hover:text-background shadow-md",
        ctaSecondary: "bg-primary/80 text-primary-foreground hover:bg-foreground hover:text-background shadow-md",
        nav: "bg-primary text-primary-foreground hover:bg-foreground hover:text-background font-semibold",
      },
      size: {
