...
const MilestoneIntro = () => {
  return (
    <>
      {/* Hero Section */}
      <section className="bg-[#ffffff] rounded-2xl border border-[#1a9fb0]/20 shadow-card animate-fade-in px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="order-2 md:order-1 text-justify text-[#4b4b4b]">
              <div className="inline-block backdrop-blur-sm rounded-full mb-4 shadow-soft">
                <span className="text-2xl text-[#1a9fb0] font-semibold">
