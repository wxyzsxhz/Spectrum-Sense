...
const MilestoneCard = ({ milestone, onClick }: MilestoneCardProps) => {
  return (
    <button
      onClick={onClick}
      className="bg-[#ffffff] w-full text-left group rounded-lg border border-[#1a9fb0]/30 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
    >
      {/* Image section */}
      <div
        className={cn(
