...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Our screening tool is designed for children between 18 months and 11 years of age, which is the critical window for early detection and intervention. However, we also provide resources for older children and adults.",
  },
  {
          ...
          <div className="container mx-auto px-2 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              {visionItems.map((item) => (
                <div
                  key={item.title}
                  className="bg-[#fff] rounded-xl p-8 shadow-sm border border-gray-200 hover:shadow-md transition"
                >
                  {/* Centered icon + title */}
              ...
              <Accordion type="single" collapsible className="space-y-4">
                {faqItems.map((item, index) => (
                  <AccordionItem
                    key={index}
                    value={`item-${index}`}
                    className="bg-[#fff] rounded-xl border border-gray-200 px-6"
                  >
        ...
        <section className="py-2 lg:py-6 mb-6">
          <div className="container mx-auto px-3 lg:px-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {/* Email */}
              <div className="bg-[#fff] rounded-xl p-8 text-center shadow-sm border border-gray-200 hover:shadow-md transition">
